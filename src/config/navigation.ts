    ...
    items: [
      {
        ...
        description: 'Что сейчас лежит на складе',
      },
      {
        label: 'Приходы',
      ...
      },
      {
        ...
        description: 'Пересчёт и акт расхождений',
      },
      {
        label: 'Продажи',
        to: routes.sales,
        ...
        description: 'Отгрузка клиенту со склада',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: ScanLine,
        permission: Permission.InventoryRead,
        description: 'Карточки позиций, не остатки',
      },
    ],
  },
  {
