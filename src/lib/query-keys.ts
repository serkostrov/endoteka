export const queryKeys = {
  ...
  users: {
    all: ['users'] as const,
    list: (filters: { search: string; roleId: string; status: string; page: number; pageSize: number }) =>
  ...
  customers: {
    ...
    list: (filters: { search: string; page: number; pageSize: number; kind?: string }) =>
      ['customers', 'list', filters] as const,
    search: (filters: { query: string; page: number; pageSize: number }) =>
      ['customers', 'search', filters] as const,
  ...
  inventory: {
    ...
    stock: (filters: { search: string; page: number; pageSize: number; stock?: string }) =>
    ...
    countLines: (id: string, filters: { search: string; filter: string; page: number; pageSize: number }) =>
  ...
  services: {
    ...
    templates: (filters: { search: string; page: number; pageSize: number; activeOnly: boolean }) =>
